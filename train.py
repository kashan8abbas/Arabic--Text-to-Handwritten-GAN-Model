...
from utils import vocab_size, encode_text
...
discriminator = Discriminator(img_channels, embed_dim).to(device)
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        fake_img = generator(sample_noise, text_embed).detach()
